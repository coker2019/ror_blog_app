...
RSpec.describe 'User', type: :feature do
  before(:each) do
    @user = User.create(name: 'Maurice coker', bio: 'Teacher from Mexico', photo_link: 'photo',
                        posts_counter: 0)
    @post4 = Post.create(title: 'Hello', text: 'How to make a blog', author_id: @user.id, comments_counter: 0,
                         likes_counter: 0)
    @post3 = Post.create(title: 'Hi', text: 'How to strong', author_id: @user.id, comments_counter: 0,
                         likes_counter: 0)
