...
The Blog app exemplifies a classic blog website. It is a fully functional platform designed to display a list of posts, enabling readers to engage by leaving comments and expressing appreciation through liking post.
...
### Tech Stack
 <a name="ruby on rails">https://rubyonrails.org/</a>
...
```sh
  cd my-folder
  git clone git@github.com:coker2019/my_blog_app.git
```
-
